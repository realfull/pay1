...
<meta charset="utf-8">
    ...
    <meta content="<?php echo $conf['web_name']?>,免费源码网 www.pxula.cn-会支付会生活" name="description"/>
    <meta name="author" content="www.ye67t.cn" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-0 text-center">
                                    <a href="submit2.php?type=alipay&trade_no=<?php echo $trade_no?>"><button class="btn btn-primary">支付宝</button></a>&nbsp;<a href="submit2.php?type=qqpay&trade_no=<?php echo $trade_no?>"><button class="btn btn-primary">QQ钱包</button></a>&nbsp;<a href="submit2.php?type=tenpay&trade_no=<?php echo $trade_no?>"><button class="btn btn-primary">财付通</button></a><br/><br/><a href="submit2.php?type=wxpay&trade_no=<?php echo $trade_no?>"><button class="btn btn-primary">微信支付</button></a>
                                </div>
                        </div>
                    </div>
            </div>
