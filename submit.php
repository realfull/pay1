...
$parameter = array(
	...
	"type" => $type,
	"notify_url"	=> 'http://'.$conf['local_domain'].'/opyzf_alipay_notify.php',
	"return_url"	=> 'http://'.$_SERVER['HTTP_HOST'].'/opyzf_alipay_return.php',
...
if($conf['alipay_mode']==3){
	...
	echo "<script>window.location.href='./codepay.php?trade_no={$trade_no}&type=alipay&sitename={$sitename}';</script>";
...
$parameter = array(
	"pid" => trim($alipay_config['partner']),
	"type" => $type,
	"notify_url"	=> 'http://'.$conf['local_domain'].'/opyzf_wxpay_notify.php',
	"return_url"	=> 'http://'.$_SERVER['HTTP_HOST'].'/opyzf_wxpay_return.php',
	"out_trade_no"	=> $trade_no,
	"name"	=> $name,
	"money"	=> $money
);
...
if($conf['wxpay_mode']==3){
	...
	echo "<script>window.location.href='./codepay.php?trade_no={$trade_no}&type=wxpay&sitename={$sitename}';</script>";
...
$parameter = array(
	"pid" => trim($alipay_config['partner']),
	"type" => $type,
	"notify_url"	=> 'http://'.$conf['local_domain'].'/opyzf_qqpay_notify.php',
	"return_url"	=> 'http://'.$_SERVER['HTTP_HOST'].'/opyzf_qqpay_return.php',
	"out_trade_no"	=> $trade_no,
	"name"	=> $name,
	"money"	=> $money
);
...
if($conf['qqpay_mode']==3){
	...
	echo "<script>window.location.href='./codepay.php?trade_no={$trade_no}&type=qqpay&sitename={$sitename}';</script>";
...
$parameter = array(
	"pid" => trim($alipay_config['partner']),
	"type" => $type,
	"notify_url"	=> 'http://'.$conf['local_domain'].'/opyzf_tenpay_notify.php',
	"return_url"	=> 'http://'.$_SERVER['HTTP_HOST'].'/opyzf_tenpay_return.php',
	"out_trade_no"	=> $trade_no,
	"name"	=> $name,
	"money"	=> $money
);
...
if($conf['tenpay_mode']==3){
	...
	echo "<script>window.location.href='./codepay.php?trade_no={$trade_no}&type=tenpay&sitename={$sitename}';</script>";
