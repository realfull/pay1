...
$target_url = ($_SERVER['SERVER_PORT'] == '443' ? 'https://' : 'http://').$_SERVER['HTTP_HOST'].'/codepay.php?trade_no='.$trade_no.'&type=wxpay';
?>
<html lang="zh-cn">
<head>
  <meta charset="utf-8"/>
...
<div class="panel panel-primary">
	<div class="panel-heading" style="text-align: center;"><h3 class="panel-title">
		<img src="//shepay.ayunx.com/assets/icon/wechat.ico">微信支付手机版
	</div>
...
<script src="//shepay.ayunx.com/assets/js/qrcode.min.js"></script>
<script src="//shepay.ayunx.com/assets/js/qcloud_util.js"></script>
